 ...
 */
var LocalSync = function(Backbone, _, LocalStorage, store) {
...
_.extend(Backbone.LocalStorage.prototype, {
  ...
  findAll: function(callback, options) {
    ...
    var itemFetched = function(resp) {
      var jsonData = this.jsonData(resp);
      // strip off ciphertext. findAll only returns user meta data.
      delete jsonData.ciphertext;
