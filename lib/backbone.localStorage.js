...
_.extend(Backbone.LocalStorage.prototype, {
  ...
  create: function(model, callback, options) {
    ...
    this.localStorage().setItem(this.name+"-"+model.id, JSON.stringify(model.toJSON({ encrypted: options.encrypted })), cb);
  ...
  find: function(model, callback, options) {
    this.localStorage().getItem(this.name+"-"+model.id, (function(resp) { callback(this.jsonData(resp)); }).bind(this));
    return;
  },
